...
class navigation_view2 extends StatefulWidget {
  const navigation_view2({super.key});

  @override
  State<navigation_view2> createState() => _navigation_view2State();
}

class _navigation_view2State extends State<navigation_view2> {
  int _currentIndex = 0;
